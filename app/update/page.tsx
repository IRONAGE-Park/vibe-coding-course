...
const REINFORCE = [
  {
    k: "말을 고객의 말로",
    v: "고객이 쓴 단어로 첫 화면을 다시 씁니다. 한 사진 공유 서비스는 ‘업로드가 필요 없다’는 기술 설명을 바쁜 부모의 하루 이야기로 바꾸자 ‘이게 내 얘기’라는 반응이 나왔습니다.",
  },
  {
    k: "고객이 끝내 원하는 것에 맞추기",
    v: "한 장례식장은 고객과 긴 대화를 나눈 뒤 안내 책자를 시설 사진에서 고객 사진으로 바꾸고, 위로하는 데 더 많은 시간을 쓰도록 일하는 방식 자체를 고쳤습니다. 기능이 아니라 고객이 원한 것을 키웠습니다.",
  },
  {
    k: "내 취향 말고 반응으로",
    v: "마음에 들어 붙인 워크숍 이름보다 진부하다고 여긴 새 이름에 등록자가 세 배 넘게 몰린 일도 있습니다. 이름 · 문구 · 디자인은 여러 안을 사람에게 보여주고, 반응이 좋은 쪽을 남깁니다.",
  },
  {
    k: "있는 기능을 더 깊게",
      ...
      <main className="mx-auto w-full flex max-w-5xl flex-col gap-8 px-5 py-12 md:px-8">
        ...
        <section className="rounded-[24px] border border-[var(--s2-line)] bg-[var(--s2-card)] p-7 shadow-[var(--s2-shadow-lg)] md:p-9">
          ...
          <p className="mt-3 text-[14.5px] leading-[1.65] text-[var(--s2-body)]">
            이 반복은 <b>만들기 → 측정 → 배우기</b>의 한 바퀴입니다. 한 바퀴의
            끝은 배포가 아니라 <b>배운 것</b>입니다 — 그래서 이 장 뒤쪽에{" "}
            <b>&lsquo;배우는 법&rsquo;</b>을 네 부분으로 두었습니다.
          </p>
        </section>
        ...
        <section className="rounded-[24px] border border-[var(--s2-line)] bg-[var(--s2-card)] p-7 shadow-[var(--s2-shadow-lg)] md:p-9">
          ...
          <p className="mt-4 text-[15px] leading-[1.7] text-[var(--s2-body)]">
            배포가 쉬워지면 기능을 계속 얹고 싶어집니다. 하지만 밀어 넣은 기능은
            대개 서비스를 약하게 만듭니다. 좋은 시장에서는 고객이 제품을
            끌어당깁니다 — 정말 필요한 기능은 <b>사용자가 먼저 요구합니다</b>.
          </p>
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[14px] leading-[1.65] text-[var(--s2-body)]">
              ...
              업데이트 거리입니다. 처음 보는 사람 <b>5명만 해도 큰 문제는 대부분
              드러납니다</b>. 강의 뒤에 쓸 20분 대본은 아래 &lsquo;배우는 법
              ②&rsquo;에 있습니다.
            </p>
          </div>
          <Callout title="디자인이 조각나지 않게">
            사람들은 기능이 같아도 <b>보기 좋은 쪽을 더 믿고 더 쉽게
            씁니다</b>. 반대로 필요할 때마다 하나씩 덧대면 색과 버튼이 제각각인
            조각보가 되고, 신뢰가 떨어집니다. 규칙을 한 번 문서로 남겨 두세요.
          </Callout>
          <CopyBlock
            label="스타일 규칙을 문서로"
        ...
        >
          ...
          <p className="text-[14.5px] leading-[1.65] text-[var(--s2-body)]">
            같은 오류가 <b>두 번째</b> 나면 한 줄을 더 붙이세요. 문제가 생길
            때마다 &lsquo;왜?&rsquo;를 거듭 물어 뿌리를 찾고, 다음엔 같은 문제가
            없도록 막는 장치를 더합니다.
          </p>
          <CopyBlock
            label="같은 오류가 두 번째라면"
        ...
        >
          ...
          <CheckList
            items={[
              ...
              <>
                <b>모아서 한 번에 말고, 작게 자주</b> — 배포되지 않은 코드는
                창고에 쌓인 재고와 같습니다. 2주 치를 모아 올리지 말고 몇 시간
                작업마다 올리세요
              </>,
              <>
        ...
        <section className="rounded-[24px] border border-[var(--s2-line)] bg-[var(--s2-card)] p-7 shadow-[var(--s2-shadow-lg)] md:p-9">
          ...
          <p className="mt-4 text-[15px] leading-[1.7] text-[var(--s2-body)]">
            여기서 &lsquo;완료&rsquo;는 코드가 배포된 게 아니라, 사용자가 써
            보고 <b>무언가를 배웠을 때</b>입니다. 앱이 생긴 지금부터는 2장에서
            본 아이템 발전 사이클의 3·4단계 — 직접 보여주며 작게 확인하고,
            기록된 행동으로 크게 확인하는 단계입니다.
          </p>
          <div className="mt-5">
        ...
        <section className="rounded-[24px] border border-[var(--s2-line)] bg-[var(--s2-card)] p-7 shadow-[var(--s2-shadow-lg)] md:p-9">
          ...
          <p className="mt-4 text-[15px] leading-[1.7] text-[var(--s2-body)]">
            사용자의 여정을 다섯 칸으로 나눠 봅니다. 칸마다 &lsquo;이 행동을
            하면 이 단계를 지난 것&rsquo;이라고 정해 두면,{" "}
        ...
        <section className="rounded-[24px] border border-[var(--s2-line)] bg-[var(--s2-card)] p-7 shadow-[var(--s2-shadow-lg)] md:p-9">
          ...
          <p className="mt-4 text-[15px] leading-[1.7] text-[var(--s2-body)]">
            ...
            줍니다 — 방문자가 적을 때 광고로 비교 실험을 돌리면 몇 주가 지나도
            결론이 잘 나지 않지만, 직접 만난 몇 사람은 금방{" "}
            <b>&lsquo;왜&rsquo;</b>를 알려줍니다.
          </p>
          ...
          <div className="mt-6">
            <Callout title="사용자가 쌓이면 한 가지 질문">
              ...
              간다는 신호로 봅니다. 너무 일찍 물으면 의미가 없으니, 계속 쓰는
              사람이 쌓인 뒤에.
            </Callout>
          </div>
        </section>
            ...
            <CheckList
              items={[
                ...
                <>
                  ...
                  망설이는 사람을 설득하느라 매달리지 않습니다. 가장 반응이
                  뜨거운 사람들의 공통점이 다음 첫 고객입니다
                </>,
                <>
        ...
        <section className="rounded-[24px] border border-[var(--s2-line)] bg-[var(--s2-card)] p-7 shadow-[var(--s2-shadow-lg)] md:p-9">
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            />
            <p className="text-[14px] leading-[1.65] text-[var(--s2-body)]">
              매 바퀴의 끝에 배운 것을 기획서에 반영합니다. 2장의 plan.md가
              추측에서 사실로 조금씩 바뀌어 가는 것 — 그게 서비스가 강해지는
              과정입니다.
            </p>
          </div>
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <p className="text-[14px] leading-[1.65] text-[var(--s2-body)]">
              한 사진 공유 서비스 창업자는 부모보다 웨딩 사진사가 돈을 더 잘
              낸다는 걸 알게 됐지만, 그 고객들의 문제에 열정을 느끼지 못해 결국
              다른 길을 택했습니다. 데이터와 함께{" "}
        ...
        <section className="rounded-[24px] border border-[var(--s2-line)] bg-[var(--s2-card)] p-7 shadow-[var(--s2-shadow-lg)] md:p-9">
          ...
          <p className="mt-4 text-[14.5px] leading-[1.7] text-[var(--s2-body)]">
            인터뷰도 숫자도 한 주 단위로 모아 보고, 결과를{" "}
            <b>예상한 것 → 실제로 본 것 → 다음 할 일</b>로 팀과 나눕니다.
            누구나 볼 수 있게 두면 틀린 가정도 빨리 드러납니다. 오늘 통하는
            아이디어도 언젠가 낡습니다 — 이 리듬이 서비스를 계속 새롭게 합니다.
          </p>
        </section>
        ...
        <section className="rounded-[24px] border border-[var(--s2-info-line)] bg-[var(--s2-info-bg)] p-7 md:p-9">
          ...
          <p className="mt-3 text-[14.5px] leading-[1.7] text-[var(--s2-body)]">
            완벽해질 때까지 기다리지 마세요. 더 멋진 이름을 찾겠다며 1년 동안
            아이디어를 실행하지 못한 사업가도 있습니다. 통하는 이름으로 먼저
            시작했다면, 쓰는 동안 더 나은 이름을 찾았을 겁니다.{" "}
            <b>서비스도 같습니다.</b>
          </p>
        </section>
      </main>
