...
- `session1-slides.html` — 1교시 강의 슬라이드 "바이브 코딩과 함께 살아남기" (16:9, 1280×720, 40장, 페이지 번호는 CSS 카운터 자동)
  - 12~20p: 연습문제 4세트 (질문→판단: 바로 가능 / 데이터 한계 / 정책 한계 / 해결 한계) + "바이브코딩을 시작하기 전에" 정리 — 원자료는 `EXERCISES.md` 참고
